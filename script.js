...
function openPostModal(postId) {
    ...
    modalContent.innerHTML = `
        ...
        <div class="modal-footer">
            ...
            <a class="primary-link" href="${post.affiliateLink}" target="_blank" rel="noopener noreferrer">Resmi siteye git</a>
        </div>
    `;
